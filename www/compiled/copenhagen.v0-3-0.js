...
Control.prototype._mapEvent = function (event) {
  return Control.prototype.isEnvironmentMobile()
...
function CPHEditor (app, cfg) {
  ...
  if (window.ResizeObserver) {
    var resizeObserver = new window.ResizeObserver(function (resizeEntries) {
  ...
  if (window.IntersectionObserver) {
    var intersectionObserver = new window.IntersectionObserver(function (intersectionEntries) {
